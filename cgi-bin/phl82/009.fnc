<!-- Divide ocorrencia de campos repetitivos
  ...
  <!--<field action="replace" tag="049" split="occ"><pft>(v49/)</pft></field>-->
      ...
      <field action="replace" tag="065" split="occ">
        <pft>
          ,if size(v64)=10 and mid(v64,3,1)='/' and mid(v64,6,1)='/' then v64*6.4,v64*3.2,v64*0.2, else ,
          ,if size(v64)=7  and mid(v64,3,1)='/' then v64*3.4,v64*0.2,'00', else ,
          ,if size(v65)=10 and mid(v65,3,1)='/' and mid(v65,6,1)='/' then v65*6.4,v65*3.2,v65*0.2, else ,
          ,if size(v65)=7  and mid(v65,3,1)='/' then v65*3.4,v65*0.2,'00', else ,
          ,if size(v65)=4  then v65,'0000', else ,
          ,if size(v65)=6  then v65,'00'  , else ,
                               (v65/),
          ,fi,fi,fi,fi,fi,fi,
        </pft>
      </field>
