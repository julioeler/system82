...
function DrawGraphH(bg){
    ...
    if (bg.xCaptionOrientation == 'horizontal')
        ...
        d.writeln('.xvalue { font-size: 8pt; writing-mode:tb-rl; }');
    ...
    d.writeln('a {color:#0000FF; text-decoration:none; font-size: 10pt; font-weight:bolder;}');
    d.writeln('h1 {text-align:center; padding:10px; margin:10px auto 20px auto; margin-left:10px; background-color:#d0d0d0; font-size: 12px; color:#006699; border: solid 1px; }');
    d.writeln('p {text-align:left; padding:10px; margin:10px auto 20px auto; margin-left:10px; background-color:#d0d0d0; font-size: 10px; color:#006699; border: solid 1px; }');
	d.writeln('</style>');

    // Title
    d.writeln('<table border=0 cellspacing=0 cellpadding=0 id=wrapper class=graph>');
    d.writeln('<tr><td colspan=' + (bg.xValues.length + 3) + ' align=center><b>' + bg.title + '</b></tr>');
    ...
    h=heTop;
    for (i=yMax; i >= yMin; i-=yStep){
        d.writeln('<tr><td height=' + h + '><img src=/ant/img/024.gif border=0></td></tr>');
        h=step + ' class=gridleft';
    }

    d.writeln('<tr><td height=' + heAxis + ' class=gridleft><img src=/ant/img/024.gif border=0></td></tr>');
    d.writeln('<tr><td height=' + heX + '><img src=/ant/img/024.gif border=0></td></tr>');
    d.writeln('</table>');
    d.writeln('</td>');
    ...
    for (var x=0; x < bg.xValues.length; x++){
        ...
        d.writeln('<tr><td valign=bottom align=center height=' + (heTop + h) + ' class=xyvalue>'
                    + (bg.showValues ? v : '<img src=/ant/img/024.gif border=0>') + '</td></tr>');
        h = he - h;
        d.writeln('<tr><td height=' + h + ' align=center>');
        d.write('<table width="50%" cellspacing=0 cellpadding=0 ' + ((bg.showBar) ? 'class=bar' : '') + ' id=bar>');
        d.writeln('<tr><td height=' + h + '><img src=/ant/img/024.gif border=0></td></tr></table></td></tr>');
        d.writeln('<tr><td height=' + heAxis + ' class=gridbottom><img src=/ant/img/024.gif border=0></td></tr>');
    ...
    d.writeln('<td align=center colspan=' + bg.xValues.length + '><b>' + bg.xCaption + '</b></td>');
    d.writeln('</tr>');
    d.writeln('</table>');
...
function DrawGraphV(bg){
	...
	d.writeln('a {color:#0000FF; text-decoration:none; font-size: 10pt; font-weight:bolder;}');
    d.writeln('h1 {text-align:center; padding:10px; margin:10px auto 20px auto; margin-left:10px; background-color:#d0d0d0; font-size: 12px; color:#006699; border: solid 1px; }');
    d.writeln('p {text-align:center; padding:10px; margin:10px auto 20px auto; margin-left:10px; background-color:#d0d0d0; font-size: 10px; color:#006699; border: solid 1px; }');
    d.writeln('</style>');
    ...
    for (var x=0; x < bg.xValues.length; x++){
        ...
        d.writeln('<td height=' + bg.xWidth + ' class=gridleft><img src=/ant/img/024.gif border=0 width=5></td>');
        ...
        if (isIE){
            ...
            for (i=yMin; i < yMax; i+=yStep) d.writeln('<td><img src=/ant/img/024.gif border=0 height=' + bg.xWidth + ' width=' + step + ' class=' + g + '></td>');
            d.writeln('</tr></table>');
        }

        d.writeln('<table cellpadding=0 cellspacing=0 border=0 class=datatable>');
        d.writeln('<tr><td id=bar' + ((bg.showBar) ? ' class=bar' : '') + '><img src=/ant/img/024.gif border=0 height=' + (bg.xWidth/2) + ' width=' + Math.ceil(v*ratio) + '>');
    ...
    d.writeln('<td height=5 class=gridleft><img src=/ant/img/024.gif border=0 width=5></td>');
    d.writeln('<td height=5 valign=top align=left style="position:relative">');

    d.writeln('<table cellspacing=0 cellpadding=0 border=0 class=gridtable><tr>');
    for (i=yMin; i < yMax; i+=yStep) d.writeln('<td align=left class=gridbottom><img src=/ant/img/024.gif border=0 height=5 width=' + step + ' ></td>');
    d.writeln('</tr></table></td></tr>');

    d.writeln('<tr><td></td><td></td>');
    d.writeln('<td valign=top align=left style="position:relative">');
    d.writeln('<table cellspacing=0 cellpadding=0 border=0 class=gridtable><tr>');
    for (i=yMin; i <= yMax; i+=yStep) d.writeln('<td align=left valign=top class=yvalue>' + i + '<br><img src=/ant/img/024.gif border=0 height=1 width=' + step + ' ></td>');
    d.writeln('</tr></table></td></tr>');
