...
rem retag phl_acv unlock tell=1000
rem retag phl_acv_fmt unlock tell=10
echo ==========================================================
echo +++ Iniciando processo de atualizacao dos indices
echo ==========================================================
pause
rem echo +++ Formulario do tombo
rem mx 001_tbo_fmt fst=@ uctab=uctab actab=actab fullinv=001_tbo_fmt tell=10 -all now tell=10
echo +++ Tombos
...
rem echo +++ Catalogo
rem mx phl_acv fst=@ uctab=uctab actab=actab fullinv=phl_acv tell=1000 -all now
exit
