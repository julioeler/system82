...
005 0 mhu,if p(v5) then 'TDO=',select val(v5) case 1:'Audio'/,case 2:'Catalogo'/,case 3:'Arquivo'/,case 4:'Evento'/,case 5:'Imagem'/,case 6:'Jogo-Kit'/,case 7:'Livro'/,case 8:'Manuscrito'/,case 9:'Mapa'/,case 10:'Norma-Tecnica'/,case 11:'Obra-Rara'/,case 12:'Outro'/,case 13:'Partitura'/,case 14:'Patente'/,case 15:'Peca-Museu'/,case 16:'Periodico'/,case 17:'Planta-Projeto'/,case 18:'Projetos-pesquisa'/,case 19:'Relatorio'/,case 20:'Digital'/,case 21:'Tese'/,case 22:'Video'/,case 23:'Braille'/,case 24:'Sitio-Web'/,case 25:'Video-TV'/,case 26:'Midia-TV'/,case 27:'Capitulo'/,case 28:'Trabalho-congresso'/,case 29:'Publicacao-avulsa'/,case 30:'Traducao'/,case 31:'Artigo'/,case 32:'Software'/,elsecase '?'/,endsel,else 'TDO=?',fi,/
...
026 0 mhu,if p(v26) then 'COL=',select val(v26) case 1:'Obras-Referencia'/,case 2:'Vídeocassete'/,case 3:'Mapas'/,case 4:'Microfilmes'/,case 5:'Livros'/,case 6:'Periodicos'/,case 7:'CD'/,case 8:'DVD'/,case 9:'Fita-virgem'/,case 10:'Permanente'/,case 11:'Temporario'/,elsecase '?'/, endsel, else 'COL=?',fi,/
026 0 mhu,if p(v26) then 'TAR=',select val(v26) case 1:'Obras-Referencia'/,case 2:'Vídeocassete'/,case 3:'Mapas'/,case 4:'Microfilmes'/,case 5:'Livros'/,case 6:'Periodicos'/,case 7:'CD'/,case 8:'DVD'/,case 9:'Fita-virgem'/,case 10:'Permanente'/,case 11:'Temporario'/,elsecase '?'/, endsel, else 'TAR=?',fi,/
027 0 mhu,"?P027"d27/,
028 0 mhu,"?P028"d28/,
...
090 0 mhu,if p(v90) then 'STT=',select s(v90) case 'B':'Apresentar'/,case '0':'Apresentar'/,case 'C':'Ocultar'/,case '1':'Ocultar'/,case 'R':'Restrito'/,elsecase v90/, endsel,else 'STT=Apresentar'/,fi,/
091 0 mhu,"?P091"d91/,"?A091"n91/,
091 0 mhu,(|STR=|v91/),
091 0 mhu,if p(v91) then 'STR=',select val(v91) case 1:'Academico'/,case 2:'Professor'/,case 3:'Funcionario'/,case 4:'Especial'/,case 5:'Outro'/,elsecase '?'/, endsel,fi,/
092 0 mhu,"?P092"d92/,
092 4 mhu,(v92/),
093 0 mhu,"?P093"d93/,
093 4 mhu,(v93/),
