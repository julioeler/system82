  ...
  <p class="ti2" align="center">
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="5" class="tx">
      <tr bgcolor="#D3D3D3">
        ...
        <th><a class="link"><xsl:attribute name="href"><xsl:value-of select="db/link_c2"/></xsl:attribute><xsl:value-of select="db/c2txt"/></a></th>
        <th><a class="link"><xsl:attribute name="href"><xsl:value-of select="db/link_c3"/></xsl:attribute><xsl:value-of select="db/c3txt"/></a></th>
        <th><a class="link"><xsl:attribute name="href"><xsl:value-of select="db/link_c4"/></xsl:attribute><xsl:value-of select="db/c4txt"/></a></th>
      ...
      <tr>
        <td width="20%" align="left"><xsl:value-of select="c1"/></td>
        <td width="20%" align="left"><xsl:value-of select="c2"/></td>
        <td width="20%" align="left"><xsl:value-of select="c3"/></td>
        <td width="20%" align="left"><xsl:value-of select="c4"/></td>
